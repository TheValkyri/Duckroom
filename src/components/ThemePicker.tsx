...
export function ThemePicker({
  ...
  return (
    <>
      <div className="fixed inset-0 z-[65] bg-black/50 lg:hidden" onClick={onClose} aria-hidden />
      <motion.div
        role="dialog"
        aria-modal="true"
        ...
        className="fixed inset-x-0 bottom-0 z-[70] mx-auto flex max-w-lg flex-col rounded-t-[28px] border-t border-white/10 bg-card/95 backdrop-blur-md pb-safe lg:hidden"
      >
